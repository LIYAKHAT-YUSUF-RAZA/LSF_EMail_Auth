...
const ResetPassword = () => {
  ...
  const onSubmitEmail = async  (e) => {
    ...
    try {
      ...
      data.success ? toast.success(data.message) : toast.error('error in onSubmitEmail in ResetPassword.jsx' + data.message)
      data.success && setIsEmailSent(true)
    } catch (error) {
      toast.error('error in catch block onSubmitEmail in ResetPassword.jsx' + error.message)
    }
  }
